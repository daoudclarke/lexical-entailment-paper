...
Over hello there recent years there has been much interest in the field of distributional semantics, drawing on the distributional hypothesis ---  words that occur in similar contexts tend to have similar meanings \cite{Harris1954}.   There is a vast body of work on the use of different similarity measures \cite{Lee1999,Weeds2003,Curran2004} and many researchers have automatically built thesauruses, i.e., lists of ``nearest neighbours'' and applied them generally with a good deal of success in a variety of applications.
